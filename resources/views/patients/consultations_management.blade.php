<x-layouts.app :title="__('Consultations')">
        ...
        <div class=" mb-3 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="w-full md:w-auto">
                <flux:heading size="xl" level="1" class="text-center md:text-left">
                    {{ __('Gesion des Consultations') }}
                </flux:heading>
                <flux:subheading size="lg" class="mb-6 md:mb-0">{{ __('Gérer vos Consultations') }}</flux:subheading>
            </div>
            ...
            <div class="w-full md:w-auto flex justify-center md:justify-end">
                <flux:breadcrumbs>
                    ...
                    <flux:breadcrumbs.item href="#">{{ __('Consultations') }}</flux:breadcrumbs.item>
                    <flux:breadcrumbs.item>{{ __('Liste des Consultations') }}</flux:breadcrumbs.item>
                </flux:breadcrumbs>
            </div>
        </div>
    ...
    @livewire('patients.consultations')
